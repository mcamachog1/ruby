...
class ParentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parent" do
    assert_difference('Parent.count') do
      post parents_url, params: { parent: { email: @parent.email, mobile: @parent.mobile, name: @parent.name } }
    end
  ...
  test "should update parent" do
    patch parent_url(@parent), params: { parent: { email: @parent.email, mobile: @parent.mobile, name: @parent.name } }
